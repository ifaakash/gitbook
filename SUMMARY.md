...
* [AWS](README.md)
  ...
  * [How to design a ECS Service](group-2/aws/how-to-design-a-ecs-service.md)
  * [How to deploy a DAEMON service in ECS](group-2/aws/how-to-deploy-a-daemon-service-in-ecs.md)

## Group 1

* [Quickspin](group-1/quickspin/README.md)
  * [Required IAM Role in prerequisite](group-1/quickspin/required-iam-role-in-prerequisite.md)
  * [Repo Structure](group-1/quickspin/repo-structure.md)

## Group 3

* [Docker](group-3/docker/README.md)
  * [Nexus using Docker](group-3/docker/nexus-using-docker.md)
  * [Docker](group-3/docker/docker.md)
  * [Sample Dockerfile](group-3/docker/sample-dockerfile.md)
  * [Docker exectuion commands](group-3/docker/docker-exectuion-commands.md)
...
* [Exercises](group-4/exercises/README.md)
  * [Using WSL machine as runner in gitlab](group-4/exercises/using-wsl-machine-as-runner-in-gitlab.md)
  * [Login to VM](group-4/exercises/login-to-vm.md)
  * [Add WSL as runner in Gitlab](group-4/exercises/add-wsl-as-runner-in-gitlab.md)
  * ["E: Unable to locate package python3-pip"](group-4/exercises/e-unable-to-locate-package-python3-pip.md)
  * [Perform SSH commands inside VM using pipeline](group-4/exercises/perform-ssh-commands-inside-vm-using-pipeline.md)
  * [Enter the password in sudo command](group-4/exercises/enter-the-password-in-sudo-command.md)
...
* [Ansible](group-5/ansible/README.md)
  * [Ansible vs Terraform](group-5/ansible/ansible-vs-terraform.md)

## Group 6

* [FitBuddy](group-6/fitbuddy/README.md)
  * [Repository Structure and Local Setup](group-6/fitbuddy/repository-structure-and-local-setup.md)
